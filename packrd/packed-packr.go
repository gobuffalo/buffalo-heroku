...
var _ = func() error {
	const gk = "ddeb6afb74b20446fc47cafb85f28b77"
	g := packr.New(gk, "")
	hgr, err := resolver.NewHexGzip(map[string]string{
		...
		"e5155e52cc01312889acbea8122d99c8": "",
	})
	if err != nil {
		panic(err)
	}
	...
	func() {
		b := packr.New("github.com/gobuffalo/buffalo-docker/genny/config", "../config/templates")
		b.SetResolver("heroku.yml.plush", packr.Pointer{ForwardBox: gk, ForwardPath: "e5155e52cc01312889acbea8122d99c8"})
		}()
